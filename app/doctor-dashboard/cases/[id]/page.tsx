        ...
        <div className="mb-8 flex items-start justify-between rounded-3xl border border-border bg-gradient-to-r from-purple-500/5 via-indigo-500/5 to-card p-6 shadow-sm">
          <div>
            <div className="mb-2 flex items-center gap-3">
              <h1 className="text-3xl font-bold text-foreground">Patient #{caseData.id}</h1>
            ...
            <p className="text-lg text-muted-foreground">{caseData.condition}</p>
            <p className="mt-1 text-sm text-muted-foreground/80">Case opened: {caseData.date}</p>
          </div>
